...
public class ProcessServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String parameter = request.getParameter("txtInputQuery");
            saveQuery(parameter);
            request.getSession().setAttribute("query", parameter);
    ...
    private void saveQuery(String parameter) {
        try {
            String query = "INSERT INTO  `tblquries` ( `quries`) VALUES ('" + parameter + "');";
